...
CREATE TABLE `redlist` (
  `idredList` int NOT NULL AUTO_INCREMENT,
  `idUsuarios` int NOT NULL,
  `cantidad` int DEFAULT '0',
  PRIMARY KEY (`idredList`),
  KEY `fk_usuarios_idUsuarios_idx` (`idUsuarios`),
  CONSTRAINT `fk_usuarios_idUsuarios` FOREIGN KEY (`idUsuarios`) REFERENCES `usuarios` (`idUsuarios`)
...
-- Dump completed on 2020-11-09 16:39:33
