...
CREATE TABLE `save` (
  ...
  PRIMARY KEY (`idsave`),
  KEY `fk_Usuarios_idUsuarios_idx` (`idUsuarios`),
  KEY `fk_Publicaciones_idPublicaciones_idx` (`idPublicaciones`),
  CONSTRAINT `fk_save_idPublicaciones` FOREIGN KEY (`idPublicaciones`) REFERENCES `publicaciones` (`idPublicaciones`),
  CONSTRAINT `fk_save_idUsuarios` FOREIGN KEY (`idUsuarios`) REFERENCES `usuarios` (`idUsuarios`)
