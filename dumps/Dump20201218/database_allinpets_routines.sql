...
/*!50003 DROP FUNCTION IF EXISTS `insert_chat` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `insert_chat`(idA int, idB int) RETURNS int
    READS SQL DATA
BEGIN
	DECLARE id_chat int;
	SELECT idChat INTO id_chat from chat where (idUserA=idA && idUserB=idB) or (idUserA=idB && idUserB=idA);
    IF id_chat IS NULL THEN
		INSERT INTO chat(idUserA,idUserB) values(idA, idB);
...
-- Dump completed on 2020-12-18 16:36:04
